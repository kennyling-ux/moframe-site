      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-balance">
            Us vs. The{" "}
            <span className="text-muted-foreground line-through decoration-red-400">Typical Agency</span>
          </h2>
        </motion.div>
        ...
        >
          {/* Header */}
          <div className="grid grid-cols-3 bg-[oklch(0.13_0.02_264)] text-white">
            <div className="px-4 sm:px-6 py-4 text-sm font-semibold text-white/70">What you get</div>
            <div className="px-4 sm:px-6 py-4 text-sm font-semibold text-red-400 border-l border-white/10">
              Typical Agency
            </div>
            <div className="px-4 sm:px-6 py-4 text-sm font-semibold text-emerald-400 border-l border-white/10">
              MoFrame ✓
            </div>
          </div>
          ...
          {rows.map((row, i) => (
            <motion.div
              ...
              className={`grid grid-cols-3 border-b border-border last:border-0 transition-colors hover:bg-[oklch(0.97_0.005_264)] ${
                i % 2 === 0 ? "bg-white" : "bg-[oklch(0.99_0.002_264)]"
              }`}
            >
              <div className="px-4 sm:px-6 py-4 text-sm font-medium text-foreground">
                {row.label}
              </div>
              <div className="px-4 sm:px-6 py-4 text-sm text-red-500 border-l border-border flex items-start gap-2">
                <X className="w-4 h-4 mt-0.5 shrink-0 text-red-400" />
                <span>{row.them}</span>
              </div>
              <div className="px-4 sm:px-6 py-4 text-sm text-emerald-700 border-l border-border flex items-start gap-2 font-medium">

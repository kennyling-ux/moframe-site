...
export default function Problem() {
  ...
  return (
    <section ref={ref} className="py-24 px-4 sm:px-6 bg-[oklch(0.97_0.005_264)]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <span className="inline-block px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-widest bg-red-50 text-red-600 border border-red-100 mb-4">
            The Problem
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-balance">
            Most SMEs Pay RM&nbsp;5,000–10,000{" "}
            <span className="text-red-500">Before Marketing Even Starts</span>
          </h2>
        ...
        >
          {pains.map(({ icon: Icon, stat, title, body }) => (
            <motion.div
              ...
              className="group relative bg-white rounded-2xl border border-red-100 p-6 hover:border-red-200 hover:shadow-lg transition-all duration-300"
            >
              ...
              <div className="text-2xl font-bold text-red-500 mb-1">{stat}</div>
        ...
        >
          <div className="inline-block bg-white border border-border rounded-2xl px-8 py-6 shadow-sm">
